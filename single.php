					...
					<div class="row">
						<div class="col s12 m6 l8">
							...
							<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
					         ...
					         <p style="margin-top: 80px;"><a href="<?php bloginfo('url'); ?>/category/noticias" class="waves-effect waves-light btn-large">ver mais notícias</a></p>
						...
						<div class="col s12 m6 l4">
							...
							<h2 class="titulo">
								...
								<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
									...
									<div class="lista-du box-noticia">
										<h4>
											<span><?php echo get_the_date('d'); ?> de <?php echo get_the_date('F'); ?></span>
										...
										<p class="tapx" style="margin-top: 0"><? $content = get_the_excerpt();
