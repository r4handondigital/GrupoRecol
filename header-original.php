        		...
        		<div class="row">
					<div class="col s12">
						<ul class="social right">
							<li><a href="https://www.instagram.com/gruporecol/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							<li><a href="https://www.linkedin.com/in/grupo-recol-1611a7153" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							<li><a href="https://www.facebook.com/gruporecolbr/" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						</ul>
					</div>
        		</div>	
        		 <nav>
				  ...
				  <div class="row">
						 <div class="col s6 offset-s6 detalhe">
					<h5>O Grupo Recol é genuinamente Acriano. Há mais de 30 anos contribuindo para o desenvolvimento do Estado. São 11 empresas, 2 mil empregos diretos e milhares indiretos.</h5>
<p class="center"><a href="<?php bloginfo('url'); ?>/institucional" class="waves-effect waves-light cpx btn-large">Saiba mais sobre o Grupo</a></p>
				</div>
				<?php else: ?>
				  </div><!--row-->
 				<?php endif ?>
...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="<?php bloginfo('url'); ?>/diretoria">DIRETORIA</a></li>
       		...
       		<section class="super-destaque owl-carousel owl-theme">
       			<?php query_posts(array( 'post_type' => 'empresas','showposts' => '5' )); ?>
					<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
						<div class="item">
